...
This is a sample template for s3-portfolio-image-change - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name s3-portfolio-image-change \
...
aws cloudformation describe-stacks \
    --stack-name s3-portfolio-image-change --query 'Stacks[].Outputs'
```
